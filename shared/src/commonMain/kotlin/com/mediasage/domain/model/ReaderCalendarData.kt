 ...
 * (figures, weekly assignments, per-day briefing reporters, and the latest saved quote); turning
 * it into displayable week slots and day cells is the UI layer's job, not the domain's.
 */
