...
6. Write `/tmp/jira_comment.txt` — see Agent Guidelines for format rules. Content: what was changed (or why no change was needed), PR URL (`gh pr view <pr-number> --json url -q .url`), quality gate results.
