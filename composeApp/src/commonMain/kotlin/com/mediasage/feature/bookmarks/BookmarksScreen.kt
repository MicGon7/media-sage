...
import mediasage.composeapp.generated.resources.bookmarks_coming_soon
...
@Composable
fun BookmarksScreen(onNavigateBack: () -> Unit = {}) {
    Surface(modifier = Modifier.fillMaxSize()) {
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            Box(
                ...
                Text(
                    text = stringResource(Res.string.bookmarks_coming_soon),
