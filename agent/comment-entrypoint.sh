...
# jiraTicketKey is set when TICKET_KEY is a synthetic dedup key (e.g. PR-200).
...
# Comment jobs typically complete in under 5 minutes; the 1-hour token TTL covers this.
