...
abstract class MediaSageDatabase : RoomDatabase() {
    ...
    abstract fun discoveredQuoteDao(): DiscoveredQuoteDao
    abstract fun userReflectionNoteDao(): UserReflectionNoteDao
    abstract fun localAccountKeyDao(): LocalAccountKeyDao
}
